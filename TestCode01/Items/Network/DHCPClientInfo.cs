...
namespace TestCode01.Items.Network
{
    internal class DHCPClientInfo
    {
        ...
        public static DHCPClientInfo Load(ManagementObject netConfig, string deviceID, bool isEmptyNetworkAddress)
        {
            if (isEmptyNetworkAddress || string.IsNullOrEmpty(deviceID)) return null;
